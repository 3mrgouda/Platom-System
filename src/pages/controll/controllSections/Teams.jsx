    ...
    <div className="w-full">
      <div className="w-full container lg:mx-auto">
        ...
        >
          ...
          <button
            type="submit"
            className="flex items-center text-xl border-solid border-2 shadow-md hover:shadow-sm shadow-black hover:shadow-purple-500 border-purple-500 rounded-md py-1 hover:border-black duration-200 hover:scale-105 px-2"
          >
            <FaPlus className="mr-1" /> Team
          </button>
        </form>
